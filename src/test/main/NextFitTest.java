...
public class NextFitTest {
    ...
    public void testNextFit() {
        ...
        Map<String, Integer> result = nextFit.assign(group,jobs);
        System.out.println("NextFit main.algorithm runs in " + stopwatch.elapsedTime()+" with successfully assigned job " +result.size());
    }
    @After
    @Deprecated
